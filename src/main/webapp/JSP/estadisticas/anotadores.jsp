            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ml-auto">
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="${pageContext.servletContext.contextPath}/JSP/estadisticas.html">Estadisticas</a></li>
        ...
        <section class="page-section" id="contact">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">Máximos Anotadores</h2>
                    <h3 class="section-subheading text-muted">listado de anotadores y sus resultados.</h3>
                </div>
                    <div class="row align-items-stretch mb-5 tablaAnotadores">
                        
                        <c:set var="listado" value="${requestScope.listado}"/>
                        <table id="jugadores" class="display anotadores" style="width:100%">
                            <thead>
                                <tr>
                                    <th>Nombre</th>
                                    <th>Equipo</th>
