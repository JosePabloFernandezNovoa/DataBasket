        ...
        <section class="page-section" id="contact">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">Máximos Taponadores</h2>
                    <h3 class="section-subheading text-muted">listado de taponadores y sus resultados.</h3>
                </div>
                    <div class="row align-items-stretch mb-5 tablaTapones">
                        
                        <c:set var="listado" value="${requestScope.listado}"/>
                        <table id="jugadores" class="display tapones" style="width:100%">
                            <thead>
                                <tr>
                                    <th>Nombre</th>
                                    <th>Equipo</th>
